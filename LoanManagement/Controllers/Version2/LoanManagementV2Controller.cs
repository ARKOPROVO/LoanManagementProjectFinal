...
namespace LoanManagement.Controllers
{
    ...
    [ApiVersion("1.0")]
    [Route("api/v1.0/LoanManagementV2")]
    [ApiController]
    public class LoanManagementV2Controller : ControllerBase
    {
        LoanDBContext _loanDBContext;
        LoanManagementRepository _loanManagementRepository;
        private readonly ILogger _logger;
        public LoanManagementV2Controller(LoanDBContext loanDBContext, ILogger<LoanManagementController> logger)
        {
